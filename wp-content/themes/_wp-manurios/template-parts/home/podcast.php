...
<section id="podcast" class="py-20 lg:py-32 bg-green">
    <div class="container mx-auto px-4 lg:px-8">
        <?php
        $spotify_url = trim( (string) get_theme_mod( 'spotify_url', '' ) );
        $youtube_url = trim( (string) get_theme_mod( 'youtube_url', '' ) );
        $spotify_embed_url = '';
            ...
            <div class="space-y-8">
                ...
                <div class="flex flex-wrap gap-4">
                    <?php if ( ! empty( $youtube_url ) ) : ?>
                        <a href="<?php echo esc_url( $youtube_url ); ?>" target="_blank" rel="noopener noreferrer" class="inline-flex items-center px-6 py-4 bg-white text-brand-green font-semibold rounded-lg hover:bg-gray-100 transition-all shadow-lg hover:shadow-xl hover:scale-105 transform duration-300">
                    ...
                    <?php if ( ! empty( $spotify_url ) ) : ?>
                        <a href="<?php echo esc_url( $spotify_url ); ?>" target="_blank" rel="noopener noreferrer" class="inline-flex items-center px-6 py-4 border-2 border-white text-white font-semibold rounded-lg hover:bg-white hover:!text-brand-green transition-all hover:scale-105 transform duration-300">
                            <svg class="w-5 h-5 mr-2" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                            ...
                            <?php foreach ( $podcast_items as $item ) : ?>
                                <?php
                                    ...
                                    if ( empty( $thumb_url ) ) {
                                        ...
                                        if ( isset( $itunes_image[0]['attribs']['']['href'] ) ) {
                                            $thumb_url = $itunes_image[0]['attribs']['']['href'];
                                        }
                                    }
