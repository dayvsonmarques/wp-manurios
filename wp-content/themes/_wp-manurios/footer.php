...
<section id="contact" class="pt-32 pb-32 lg:pt-40 lg:pb-44 bg-green">
		...
		<div class="max-w-4xl mx-auto text-center">
			<div class="flex justify-center gap-12 lg:gap-16">
				...
				<?php if ( ! empty( $spotify_url ) ) : ?>
					<a href="<?php echo esc_url( $spotify_url ); ?>" target="_blank" rel="noopener noreferrer" class="text-white hover:text-brand-gold transition-colors" aria-label="Spotify">
						<svg class="w-12 h-12 lg:w-14 lg:h-14" fill="currentColor" viewBox="0 0 24 24">
				...
				<a href="https://www.youtube.com/@saudem1lugar" target="_blank" rel="noopener noreferrer" class="text-white hover:text-brand-gold transition-colors" aria-label="YouTube">
					<svg class="w-12 h-12 lg:w-14 lg:h-14" fill="currentColor" viewBox="0 0 24 24">
						<path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
					</svg>
				</a>

				<a href="https://www.linkedin.com/in/manurios/" target="_blank" rel="noopener noreferrer" class="text-white hover:text-brand-gold transition-colors" aria-label="LinkedIn">
					<svg class="w-12 h-12 lg:w-14 lg:h-14" fill="currentColor" viewBox="0 0 24 24">
...
$whatsapp_url     = 'https://wa.me/' . esc_attr($whatsapp_phone) . '?text=' . urlencode($whatsapp_message);
?>
<a href="<?php echo esc_url($whatsapp_url); ?>"
	id="btn-whatsapp-float"
	target="_blank"
	rel="noopener noreferrer"
	class="fixed bottom-6 right-6 z-50 bg-green-500 hover:bg-green-600 text-white rounded-full p-4 shadow-2xl hover:shadow-green-500/50 transition-all duration-300 hover:scale-110 group"
